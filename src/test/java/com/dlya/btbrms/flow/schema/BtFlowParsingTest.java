...
public class BtFlowParsingTest {
                ...
                .hasEntrySatisfying("decision1", start -> assertThat(start)
                        ...
                        .satisfies(array -> assertThat(array)
                                ...
                                .satisfies(entry -> assertThat(entry)
                                        ...
                                        .hasFieldOrPropertyWithValue("operator", BtECondOperator.EQUALS)
                                        .satisfies(source -> assertThat(source)
                        ...
                        .satisfies(array -> assertThat(array)
                                ...
                                .satisfies(entry -> assertThat(entry)
                                        ...
                                        .hasFieldOrPropertyWithValue("operator", BtECondOperator.GREATER_THAN)
                                        .satisfies(source -> assertThat(source)
                                                .extracting("value", as(type(BtReferenceScalarConst.class)))
                                                .hasFieldOrPropertyWithValue("type", BtEReferenceType.CONSTANT)
                                ...
                                .satisfies(entry -> assertThat(entry)
                                        ...
                                        .hasFieldOrPropertyWithValue("operator", BtECondOperator.CONTAINS)
                                        .satisfies(source -> assertThat(source)
                                                .extracting("value", as(type(BtReferenceScalarConst.class)))
                                                .hasFieldOrPropertyWithValue("type", BtEReferenceType.CONSTANT)
                        ...
                        .satisfies(array -> assertThat(array)
                                ...
                                .satisfies(entry -> assertThat(entry)
                                        ...
                                        .hasFieldOrPropertyWithValue("operator", BtECondOperator.STARTS_WITH)
                                        .satisfies(source -> assertThat(source)
                                                .extracting("value", as(type(BtReferenceScalarConst.class)))
                                                .hasFieldOrPropertyWithValue("type", BtEReferenceType.CONSTANT)
                                                .hasFieldOrPropertyWithValue("value", "STR_KEY")
    ...
    public void testResources() {
        assertThat(schemaResources)
                .isNotNull()
                .extracting("flowResources", as(map(String.class, BtFlowResource.class)))
                .isNotNull()
                .hasSize(2)
                .hasEntrySatisfying("two", resource -> assertThat(resource)
                ...
                .hasEntrySatisfying("var1", resource -> assertThat(resource)
